...
from app.schemas.integration_contracts import MCP_CONTRACT_VERSION, integration_contract_header
...
def mcp_capabilities(response: Response) -> IntegrationCapabilities:
    response.headers["X-Integration-Contract"] = integration_contract_header("mcp", MCP_CONTRACT_VERSION)
