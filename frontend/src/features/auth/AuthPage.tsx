        ...
        <div className="card-body p-4">
          <div className="d-flex justify-content-between align-items-center gap-2 mb-3">
            <div>
              ...
              <p className="text-muted mb-0">Use your account to sync Today, Calendar, and future planning modules.</p>
            </div>
          </div>
          ...
          <form className="d-grid gap-3" onSubmit={onSubmit}>
            ...
            <button type="submit" className="btn btn-primary" disabled={isSubmitting}>
              {isSubmitting ? (mode === 'login' ? 'Signing in…' : 'Creating account…') : mode === 'login' ? 'Login' : 'Create account'}
            </button>
          </form>
        </div>
      </div>
