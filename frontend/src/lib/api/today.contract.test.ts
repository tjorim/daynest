...
const _todayKeysAreStable: Expect<
  Equal<
    TodayTopLevelKeys,
    | "medication"
    | "medication_history"
...
describe("TodayPayload contract", () => {
  it("has all expected top-level keys", () => {
    const keys: TodayTopLevelKeys[] = Object.keys(contractExample) as TodayTopLevelKeys[];
    const expected: TodayTopLevelKeys[] = [
      "medication",
      "medication_history",
      "routines",
      "overdue",
