...
from custom_components.daynest.config_flow_handler.validators import validate_credentials
from custom_components.daynest.const import DOMAIN, LOGGER
from homeassistant import config_entries
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME
from homeassistant.loader import async_get_loaded_integration

if TYPE_CHECKING:
    from custom_components.daynest.config_flow_handler.options_flow import DaynestOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "DaynestApiClientAuthenticationError": "auth",
    "DaynestApiClientCommunicationError": "connection",
}
...
class DaynestConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.daynest.config_flow_handler.options_flow import (  # noqa: PLC0415
            DaynestOptionsFlow,
        )

        return DaynestOptionsFlow()
