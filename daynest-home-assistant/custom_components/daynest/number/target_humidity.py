"""Target humidity number for daynest."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.daynest.api import DaynestApiClientError
...
class DaynestHumidityNumber(NumberEntity, DaynestEntity):
