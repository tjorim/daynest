...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `Daynest`
...
- Inherit from both platform entity and `DaynestEntity` (order matters)
...
from custom_components.daynest.sensor import async_setup_entry
...
**Config entry data:** `entry_data: DaynestData = hass.data[DOMAIN][entry.entry_id]`
