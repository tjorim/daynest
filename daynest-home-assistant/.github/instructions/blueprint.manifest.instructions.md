...
**Applies to:** `custom_components/daynest/manifest.json`
...
```json
{
  ...
  "codeowners": ["@daynest"],
  "config_flow": true,
  "documentation": "https://github.com/daynest/daynest-home-assistant",
  "integration_type": "device",
  "iot_class": "cloud_polling",
  "issue_tracker": "https://github.com/daynest/daynest-home-assistant/issues",
  "requirements": [],
  "version": "0.0.0"
}
```
