...
- **Main code:** `custom_components/daynest/`
...
- `entity/` — Base entity class (`DaynestEntity`)
...
- Entity MRO: `(PlatformEntity, DaynestEntity)` — order matters
...
- Debug level: `custom_components.daynest: debug` in `config/configuration.yaml`
