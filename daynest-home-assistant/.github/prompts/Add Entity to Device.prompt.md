...
- Inherit from `DaynestEntity` and platform base class
...
- Entity: `custom_components/daynest/[platform]/[entity_name].py`
- Platform: `custom_components/daynest/[platform]/__init__.py`
