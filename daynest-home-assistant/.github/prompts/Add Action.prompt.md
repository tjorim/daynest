...
**File:** `custom_components/daynest/services.yaml`
...
Create `custom_components/daynest/service_actions/[action_name].py`:

```python
"""[Action name] service action for Daynest."""
...
**File:** `custom_components/daynest/__init__.py`
...
**File:** `custom_components/daynest/const.py`
...
3. Find service action: `daynest.[action_name]`
...
- **Domain:** `daynest`
- **Service actions directory:** `custom_components/daynest/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/daynest/services.yaml` (legacy filename)
- **Icons:** `custom_components/daynest/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/daynest/translations/*.json` under `services` key (legacy)
