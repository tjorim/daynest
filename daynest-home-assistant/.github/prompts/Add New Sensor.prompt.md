...
- Create new sensor file in `custom_components/daynest/sensor/`
- Inherit from `DaynestEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Daynest."""
...
class Daynest[SensorName]Sensor(
    DaynestEntity,
    SensorEntity,
):
...
- Entity: `custom_components/daynest/sensor/[sensor_name].py`
- Platform: `custom_components/daynest/sensor/__init__.py`
- Translations: `custom_components/daynest/translations/*.json`
