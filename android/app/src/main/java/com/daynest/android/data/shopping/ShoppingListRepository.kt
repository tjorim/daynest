...
constructor(
    ...
    suspend fun getShoppingList(id: Int): Result<ShoppingListDto> = safeApiCall { shoppingListApi.getShoppingList(id) }
    ...
    suspend fun updateShoppingList(id: Int, request: ShoppingListUpdateDto): Result<ShoppingListDto> =
