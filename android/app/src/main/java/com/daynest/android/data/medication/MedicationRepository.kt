...
@Inject
constructor(private val medicationApi: MedicationApi) {
    ...
    suspend fun deletePlan(id: Int): Result<Unit> = safeApiCall {
        medicationApi.deletePlan(id)
        Unit
    }

    suspend fun getHistory(): Result<List<MedicationHistoryItemDto>> = safeApiCall {
