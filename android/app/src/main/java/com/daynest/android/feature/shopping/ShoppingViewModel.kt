...
constructor(
    ...
    fun createList(name: String, store: String?, notes: String?) {
    ...
    fun addItem(title: String, tag: String?, notes: String?) {
...
private fun PlannedTodayItemDto.toUpdateDto(isDone: Boolean = this.isDone): PlannedItemUpdateDto = PlannedItemUpdateDto(
    title = title,
