...
constructor(
    ...
    private suspend fun updateSmallWidgets(manager: GlanceAppWidgetManager, widgetState: TodayWidgetState) {
    ...
    private suspend fun updateMediumWidgets(manager: GlanceAppWidgetManager, widgetState: TodayWidgetState) {
    ...
    private suspend fun updateMediumWidget(id: GlanceId, widgetState: TodayWidgetState) {
        updateAppWidgetState(appContext, PreferencesGlanceStateDefinition, id) { prefs ->
            prefs
    ...
    private fun MutablePreferences.applyWidgetBase(widgetState: TodayWidgetState): MutablePreferences = apply {
    ...
    private fun MutablePreferences.applyMediumWidgetState(widgetState: TodayWidgetState): MutablePreferences = apply {
    ...
    private fun MutablePreferences.applyNoDataState(): MutablePreferences = apply {
