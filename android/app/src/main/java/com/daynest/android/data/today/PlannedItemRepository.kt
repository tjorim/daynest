...
constructor(
    ...
    ): Result<PlannedTodayItemDto> = updatePlannedItem(
        id,
    ...
    suspend fun updatePlannedItem(
        ...
        scope: EditScope = EditScope.THIS
    ): Result<PlannedTodayItemDto> = safeApiCall {
    ...
    suspend fun deletePlannedItem(id: Int, scope: DeleteScope = DeleteScope.THIS): Result<Unit> = safeApiCall {
    ...
    suspend fun createPlannedItem(request: PlannedItemCreateDto): Result<PlannedTodayItemDto> = safeApiCall {
    ...
    suspend fun listPlannedItems(startDate: String?, endDate: String?): Result<List<PlannedTodayItemDto>> {
    ...
    private fun plannedItemsCacheKey(startDate: String?, endDate: String?): String =
        "${SyncCacheKeys.PLANNED_ITEMS}:${startDate.orEmpty()}:${endDate.orEmpty()}"
}
